...
Date.prototype.getWeek = function () {
  ...
  function dayTwoOfWeek(date)
    {
      var dayTwoWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 5 : 1);
  ...
  function dayThreeOfWeek(date)
    {
      var dayThreeWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 4 : 1);
  ...
  function dayFourOfWeek(date)
    {
      var dayFourWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 3 : 1);
  ...
  function dayFiveOfWeek(date)
    {
      var dayFiveWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 2 : 1);
  ...
  function daySixOfWeek(date)
    {
      var daySixWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 1 : 1);
  ...
  function daySevenOfWeek(date)
    {
      var daySevenWeek = date.getDate() - date.getDay() + (date.getDay() === 0 ? - 0 : 1);
